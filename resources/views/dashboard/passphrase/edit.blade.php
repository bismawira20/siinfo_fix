...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h2>Edit Pengajuan Reset Email atau Passphrase TTE</h2>
</div>

<div class="col-lg-7">
    <form method="post" action="{{ route('passphrase.update', $passphrase->id) }}" class="mb-5">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            id="email_domain" name="email_domain" value ="{{ old('email_domain', $passphrase->email_domain) }}">
            @error('email_domain')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            >{{ old('alasan', $passphrase->alasan) }}</textarea>
            @error('alasan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
