...
<div class="table-responsive small col-lg-15">
          ...
          <td>
            <div class="d-flex align-items-center gap-1">
              ...
              @if ($p->status !== 'disetujui' && $p->status !== 'ditolak')
                <form action="/dashboard/passphrase/admin/{{ $p->id }}/selesai" method="POST" class="d-inline m-0" 
                ...
                <form action="/dashboard/passphrase/admin/{{ $p->id }}/tolak" method="POST" class="d-inline m-0" 
  ...
  <div class="d-flex justify-content-between align-items-center">
    ...
    <form action="/dashboard/passphrase/admin/export-excel" method="GET" class="d-inline">
