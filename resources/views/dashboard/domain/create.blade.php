...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h2>Ajukan Pembuatan Sub Domain dan VPS</h2>
</div>
...
<div class="col-lg-7">
    ...
    enctype="multipart/form-data" class="mb-5">
        ...
        <div class="mb-3">
            <label for="nama_domain" class="form-label @error('nama_domain') is-invalid @enderror">Usulan Nama Domain
                <small class="form-text text-muted d-block">
                    nama.semarangkota.go.id
                </small> 
            </label>
            <input type="text" class="form-control" 
            id="nama_domain" name="nama_domain">
            @error('nama_domain')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
