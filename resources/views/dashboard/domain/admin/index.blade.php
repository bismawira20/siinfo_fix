          ...
          <td>
              <div class="d-flex align-items-center gap-1">
                  ...
                  @if ($p->status !== 'disetujui' && $p->status !== 'ditolak')
                    <form action="/dashboard/domain/admin/{{ $p->id }}/selesai" method="POST" class="d-inline m-0" 
                    ...
                    <form action="/dashboard/domain/admin/{{ $p->id }}/tolak" method="POST" class="d-inline m-0" 
