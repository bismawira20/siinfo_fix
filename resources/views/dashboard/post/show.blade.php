...
<div class="container">
  <div class="row my-3">
      <div class="col-md-8">
              ...
              <a href="/dashboard/post/" class="btn btn-success border-0 text-white"><i class="bi bi-arrow-left fs-6"></i></a>
              <a href="{{ route('post.edit', $post->id) }}" class="btn btn-warning border-0 text-white"><i class="bi bi-pencil-square fs-6"></i></a>
