<div class="terms-content">
    ...
    <div class="terms-section">
        <h6>Konfirmasi Akhir:</h6>
        <ol>
            <li>Pemohon mengonfirmasi bahwa Pemohon telah membaca dan memahami syarat dan ketentuan di atas.</li>
            <li>Pemohon melakukan pengisian data secara lengkap, benar dan sadar tanpa paksaan dari pihak manapun.</li>
            <li>Pemohon bersedia untuk mematuhi semua persyaratan keamanan informasi yang telah ditetapkan oleh Diskominfo Pemkot Semarang dan bersedia ditindak / dikenai sanksi sesuai dengan peraturan perundang undangan yang berlaku jika terjadi penyalahgunaan informasi terkait.</li>
        </ol>
    </div>

    <div class="alert alert-warning mt-3" role="alert">
        <strong>Perhatian:</strong> Dengan menyetujui syarat dan ketentuan, Anda menyatakan bahwa Anda memahami dan mematuhi seluruh ketentuan di atas.
    </div>
</div>
...
.terms-content .terms-section h6 {
    color: #333;
