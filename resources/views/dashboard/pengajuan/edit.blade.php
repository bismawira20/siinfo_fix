...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h2>Edit Pengajuan Tanda Tangan Elektronik</h2>
</div>

<div class="col-lg-7">
    <form method="post" action="{{ route('pengajuan.update', $pengajuan->id) }}" class="mb-5">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        id="nama" name="nama" value ="{{ old('nama', $pengajuan->nama) }}">
        @error('nama')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" 
            id="nip" name="nip" value = "{{ old('nip', $pengajuan->nip) }}">
            @error('nip')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" 
            id="nik" name="nik" value = "{{ old('nik', $pengajuan->nik) }}">
            @error('nik')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" 
            id="nama_opd" name="nama_opd" value = "{{ old('nama_opd', $pengajuan->nama_opd) }}">
            @error('nama_opd')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            id="no_telp" name="no_telp" value = "{{ old('no_telp', $pengajuan->no_telp) }}">
            @error('no_telp')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            id="email_domain" name="email_domain" value = "{{ old('email_domain', $pengajuan->email_domain) }}">
            @error('email_domain')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" 
            id="jabatan" name="jabatan" value = "{{ old('jabatan', $pengajuan->jabatan) }}">
            @error('jabatan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
