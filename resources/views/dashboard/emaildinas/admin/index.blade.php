        ...
        <tr>
          ...
          <td>
            ...
            @if ($p->status !== 'disetujui' && $p->status !== 'ditolak')
                    <form action="/dashboard/emaildinas/admin/{{ $p->id }}/selesai" method="POST" class="d-inline m-0" 
                    ...
                    <form action="/dashboard/emaildinas/admin/{{ $p->id }}/tolak" method="POST" class="d-inline m-0" 
