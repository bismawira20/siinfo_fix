      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a href="{{ route('cpanel.admin.show', $p->id) }}" class="badge bg-primary"><i class="bi bi-eye fs-6"></i></a>
            ...
            <form action="/dashboard/cpanel/admin/{{ $p->id }}/tolak" method="POST" class="d-inline">
              @csrf
              @method('put')
